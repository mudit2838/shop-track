                ...
                <div className="w-full max-w-md">
                    ...
                    <motion.div initial={{opacity:0, scale:0.98}} animate={{opacity:1, scale:1}}>
                        ...
                        <div className="text-center lg:text-left mb-8">
                            ...
                            <p className="text-slate-500">Sign in to your shop terminal to execute commands.</p>
                        </div>

                        <form onSubmit={handleLogin} className="bg-white p-8 rounded-2xl shadow-soft border border-slate-100">
